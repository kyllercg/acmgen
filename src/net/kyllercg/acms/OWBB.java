 ...
 * @version 1.1
 */
public class OWBB extends ACMsys {
	
	/**
	 * Class contructor
	 * 
	 * @param size - the size of the OWBB ACM
	 */
	public OWBB(int size) {
	...
	protected boolean createWriter() {
		...
		int cont;
		OWBBWriterModule aux;
		
		for (cont = 0; cont < size; cont++) {
			
			aux = new OWBBWriterModule(cont, size);
	...
	protected boolean createReader() {
		...
		int cont;
		OWBBReaderModule aux;
		
		for (cont = 0; cont < size; cont++) {
			
			aux = new OWBBReaderModule(cont, size);
	...
	/**
	 * Gets the Petri net of the OWBB ACM
	 * 
	 * @return a PetriNet object with the Petri net of a OWBB ACM
	 */
	public PetriNet getOWBB() {
